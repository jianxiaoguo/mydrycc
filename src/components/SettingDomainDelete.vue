        ...
        <div class="hk-slide-panel-overlay is-visible ember-view">
            <div class="hk-slide-panel-container shadow-outer-2 flex flex-column fixed bg-white overflow-y-hidden ma2 br2 from-right standard" >
                ...
                <div class="hk-slide-panel-content relative overflow-y-auto flex flex-column z-1 ember-view">
                    <div class="flex flex-column h-100">
                        ...
                        <div class="slide-panel-content flex-grow-1 flex-shrink-0 pa4">
                                ...
                                <div class="ember-view">
                                    <div class="collaborator-edit">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label class="f5 b gray mb2">Do you want delete the Domain of
                                                      {{ domain.domain }}
                                                    </label>
                            ...
                            <button v-if="editAccess" @click="deleteAppDomain" class="w-100 async-button default hk-button--danger ember-view" type="submit">Delete Domain</button>
                        </div>
                ...
                <div class="hk-slide-panel-footer relative shadow-outer-1 flex justify-center items-center z-2 pa4 ember-view">
                    ...
                    <button @click="deleteAppDomain" class="async-button w-50 default hk-button--primary ember-view" type="submit">Yes</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
import SettingDomainDelete from "./SettingDomainDelete"
export default SettingDomainDelete
</script>
