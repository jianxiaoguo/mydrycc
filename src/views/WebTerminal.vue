<template>
    <div ref="refTerminalWrapper" style="height: 100vh;
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const handleResize = () => {
                console.log(refTerminalWrapper.value.offsetHeight)
            ...
            pty.onData(recv => xterm.write(recv));
            xterm.onData(send => pty.write(send));



            onMounted(() => {
                console.log(refTerminal.value)
